...
{
    public abstract class BHWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BHWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BHWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BHDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BHDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BHDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BHDbContext, Task<T>> func)
        {
            T result;
